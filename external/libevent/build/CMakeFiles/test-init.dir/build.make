...
CMakeFiles/test-init.dir/test/test-init.c.o: ../test/test-init.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/linhui/workspace/OCRService/external_src/libevent/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object CMakeFiles/test-init.dir/test/test-init.c.o"
	/usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/test-init.dir/test/test-init.c.o   -c /home/linhui/workspace/OCRService/external_src/libevent/test/test-init.c
...
CMakeFiles/test-init.dir/test/test-init.c.i: cmake_force
	...
	/usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /home/linhui/workspace/OCRService/external_src/libevent/test/test-init.c > CMakeFiles/test-init.dir/test/test-init.c.i
...
CMakeFiles/test-init.dir/test/test-init.c.s: cmake_force
	...
	/usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /home/linhui/workspace/OCRService/external_src/libevent/test/test-init.c -o CMakeFiles/test-init.dir/test/test-init.c.s
...
bin/test-init: CMakeFiles/test-init.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/linhui/workspace/OCRService/external_src/libevent/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable bin/test-init"
